...
# Função para atualizar o conteúdo do Treeview
...
tree = ttk.Treeview(root, columns=["id", "produto", "classe", "quantidade", "preço", "local"], show="headings")
tree.pack(fill=tk.BOTH, expand=True)

for coluna in ["id", "produto", "classe", "quantidade", "preço", "local"]:
...
# Inicializar Treeview com dados do banco
atualizar_treeview()
